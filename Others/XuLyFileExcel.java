...
public class XuLyFileExcel {
    ...
    public void xuatExcel(JTable tbl) {
        try {
            ...
            JFileChooser chooser = new MyFileChooser("C:\\Users\\ADMIN\\Desktop\\");
            ...
            JOptionPane.showMessageDialog(null,"Xuat file that bai.");
        }
    }
    ...
    public void nhapExcel(JTable tbl) {
        try {
            ...
            JOptionPane.showMessageDialog(null,"Nhap file that bai");
        }
    }
