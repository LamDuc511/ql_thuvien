...
//contructor
    ...
    public MyConnectUnit() {
        connect = new MySQLConnection("localhost", "root", "", "ql_thuvien");
    }
...
// Một số hàm bổ sung sử dụng cho class này
...
// hàm hỗ trợ update CSDL
    /**
     * Update Table Set ColumnName = ColumnValues Where Condition
     * @throws Exception
     */
